...
export class I18nRouterLinkDirective extends RouterLinkWithHref implements AfterViewInit{
  ...
  ngAfterViewInit() {
    ...
    hrefLangLink = this.i18nService.IsDefaultLang(this.i18nService.currentLangTag)
      ? (this.i18nRouterLink.startsWith("/") ?  this.i18nRouterLink : "/" + this.i18nRouterLink)
    ...
    this.i18nService.AddLanguageChangeListener(langTag => {
      if (this.i18nService.IsDefaultLang(langTag)){
        ...
        super.routerLink = langTag + "/" + this.i18nRouterLink;
        nativeElement.href = langTag + "/" + this.i18nRouterLink;
      }
